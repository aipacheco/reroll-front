    ...
    <div className="p-3">
      <div className="centered-container container center-flex p-3">
        <div className="card p-2 text-center">
          <h2 className="h2-landing text-center">Bienvenid@ a re-roll!</h2>
          <p className="landing-text m-5">
            ...
            <br />
            <br />
            Desde los clásicos juegos de estrategia hasta las últimas novedades
            en el mundo de los juegos de mesa, aquí encontrarás todo lo que
            necesitas para vivir increíbles aventuras en cada partida.
            <br />
            <br />
